...
const packageDetails: Record<string, FullPackageDetail> = {
  budget: {
    ...
    priceRange: 'From £800',
    summary: 'A reasonably priced alternative to traditional fitted wardrobes. Standard IKEA PAX doors, boxed in with filler panels. You provide measurements and purchase the IKEA items — we handle the fitting.',
    positioning: 'Affordable pre-designed storage install.',
    coreValue: 'Quick, reliable wardrobe installation at the lowest cost. We box the wardrobe in with filler panels, giving you a built-in look. Filler panels are flush with the frame (not the doors) and colour-matched to the frame. Ideal for spare rooms, rentals, or anywhere function matters more than finish.',
    forYouIf: [
      'You want a built-in look at a lower price and accept some aesthetic compromises',
      'You\'re working to a strict budget or furnishing a rental',
      'You prefer a quick turnaround with no design decisions',
      'You don\'t mind standard IKEA doors and wider filler panels',
    ],
    includes: [
      'Professional installation',
      'Assembly & securing to wall',
      'Filler panels fitted (flush with frame)',
      'Handle fitting',
      'Post-installation support',
      'PAX interior system (changeable over time)',
    ],
    doesNotInclude: [
      'Supply of IKEA items (customer orders)',
      'Measure visit (customer provides measurements)',
      'Design consultation',
      'Custom doors or internal layouts',
      'Frame cutting, scribing, or height alterations',
      'Flush filler panels (flush with doors)',
      'Skirting board finish',
      'Cornice / coving finish',
      'Rubbish removal (customer disposes)',
      'LED lighting',
  ...
  paxbespoke: {
    ...
    includes: [
      ...
      'Doors customised within IKEA/PAX range',
    ...
    doesNotInclude: [
      ...
      'Fully bespoke, made-to-order doors (available on Select)',
      'Sliding door systems (available on Select)',
    ],
    color: '#f28c43',
    colorHover: '#e07c33',
    colorLight: '#f28c43',
  ...
  select: {
    ...
    includes: [
      ...
      'MDF cornice finish (if chosen)',
      'Custom frame adjustments',
      'Bespoke doors (spray-painted or vinyl)',
      'Custom internal layouts',
      'High-ceiling wardrobe solutions',
      'Premium finish joinery front edges',
      'Storage add-ons (top cabinets, drawers, etc.)',
